...
for table_name in $(toml_get_table_names); do
	...
	app_args[module_prop_name]=$(toml_get "$t" module-prop-name) || app_args[module_prop_name]="${table_name_f}-revanced"
...
log "\n[revanced-magisk-module](https://github.com/trapgod1/revanced-magisk-module)\n"
